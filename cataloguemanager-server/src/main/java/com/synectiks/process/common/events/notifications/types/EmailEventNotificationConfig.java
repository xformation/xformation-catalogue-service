...
public abstract class EmailEventNotificationConfig implements EventNotificationConfig {
    ...
    private static final String DEFAULT_SENDER = "cataloguemanager@example.org";
    static final String DEFAULT_SUBJECT = "cataloguemanager event notification: ${event_definition_title}";
