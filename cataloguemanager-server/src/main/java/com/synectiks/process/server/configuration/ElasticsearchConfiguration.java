...
public class ElasticsearchConfiguration {
    ...
    private String indexPrefix = "cataloguemanager";
    ...
    private String templateName = "cataloguemanager-internal";
    ...
    private String defaultEventsIndexPrefix = "xfcatlg-events";

    @Parameter(value = DEFAULT_SYSTEM_EVENTS_INDEX_PREFIX, validators = StringNotBlankValidator.class)
    private String defaultSystemEventsIndexPrefix = "xfcatlg-system-events";
