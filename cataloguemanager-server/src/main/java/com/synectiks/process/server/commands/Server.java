...
@Command(name = "server", description = "Start the cataloguemanager server")
public class Server extends ServerBootstrap {
    ...
    @Option(name = {"-l", "--local"}, description = "Run cataloguemanager in local mode. Only interesting for cataloguemanager developers.")
