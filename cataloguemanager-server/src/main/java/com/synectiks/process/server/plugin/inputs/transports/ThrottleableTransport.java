...
public abstract class ThrottleableTransport implements Transport {
    ...
    public static class Config implements Transport.Config {
        ...
        public ConfigurationRequest getRequestedConfiguration() {
            ...
            request.addField(new BooleanField(
                    ...
                    false,
                    "If enabled, no new messages will be read from this input until cataloguemanager catches up with its message load. " +
    ...
    /**
     * Performs the same purpose as {@link #launch(com.synectiks.process.server.plugin.inputs.MessageInput)} but guarantees that the superclass'
