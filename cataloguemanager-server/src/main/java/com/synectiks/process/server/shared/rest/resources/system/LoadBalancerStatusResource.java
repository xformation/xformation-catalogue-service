...
public class LoadBalancerStatusResource extends RestResource {
    ...
    @ApiOperation(value = "Get status of this cataloguemanager server node for load balancers. " +
    ...
    @ApiOperation(value = "Override load balancer status of this cataloguemanager server node. Next lifecycle " +
