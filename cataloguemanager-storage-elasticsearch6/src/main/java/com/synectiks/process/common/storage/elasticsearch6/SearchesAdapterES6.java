...
import static com.synectiks.process.server.indexer.searches.ScrollCommand.NO_LIMIT;
...
public class SearchesAdapterES6 implements SearchesAdapter {
    ...
    private static final String AGG_CARDINALITY = "xfcatlg_field_cardinality";
    private static final String AGG_EXTENDED_STATS = "xfcatlg_extended_stats";
    private static final String AGG_FILTER = "xfcatlg_filter";
    private static final String AGG_VALUE_COUNT = "xfcatlg_value_count";
