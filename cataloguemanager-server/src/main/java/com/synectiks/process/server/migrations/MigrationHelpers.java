    ...
    public String ensureUser(String userName, String password, String fullName, String email, Set<String> expectedRoles) {
        ...
        try {
            ...
            try {
                ...
                LOG.error("Unable to save fixed '" + userName + "' user, please restart cataloguemanager to fix this.", e);
            }
        }

        if (previousUser == null) {
            LOG.error("Unable to access fixed '" + userName + "' user, please restart cataloguemanager to fix this.");
            return null;
        }
