...
import com.synectiks.process.common.events.legacy.LegacyAlertConditionMigrator;
...
public class LegacyAlertConditionMigratorTest {
    ...
    public void run() {
        ...
        assertThat((LegacyAlarmCallbackEventNotificationConfig) emailNotification.config()).satisfies(config -> {
            ...
            assertThat(config.configuration().get("sender")).isEqualTo("cataloguemanager@example.org");
            assertThat(config.configuration().get("subject")).isEqualTo("cataloguemanager alert for stream: ${stream.title}: ${check_result.resultDescription}");
        ...
        assertThat((LegacyAlarmCallbackEventNotificationConfig) slackNotification.config()).satisfies(config -> {
            ...
            assertThat(config.configuration().get("cataloguemanager2_url")).isEqualTo("");
            ...
            assertThat(config.configuration().get("user_name")).isEqualTo("cataloguemanager");
