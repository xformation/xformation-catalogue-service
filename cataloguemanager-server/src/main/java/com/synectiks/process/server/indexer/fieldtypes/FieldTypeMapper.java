...
/**
 * Maps Elasticsearch field types to cataloguemanager types.
 * <p>
...
public class FieldTypeMapper {
    ...
    /**
     * A map from Elasticsearch types to cataloguemanager logical types.
     */
    ...
    /**
     * Map the given Elasticsearch field type to a cataloguemanager type.
     * @param typeName Elasticsearch type name
     * @return the cataloguemanager type object
     */
