...
@Api(value = "System/Loggers", description = "Internal cataloguemanager loggers")
@Path("/system/loggers")
public class LoggersResource extends RestResource {
    ...
    private static final String MEMORY_APPENDER_NAME = "cataloguemanager-internal-logs";

    private static final Map<String, Subsystem> SUBSYSTEMS = ImmutableMap.<String, Subsystem>of(
            "cataloguemanager", new Subsystem("cataloguemanager", ImmutableList.of("com.synectiks.process.server", "com.synectiks.process.common"), "All messages from cataloguemanager-owned systems."),
