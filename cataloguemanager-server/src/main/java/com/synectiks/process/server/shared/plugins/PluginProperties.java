...
public class PluginProperties {
    ...
    private static final String MANIFEST_ATTRIBUTE = "cataloguemanager-Plugin-Properties-Path";
    private static final String GRAYLOG_PLUGIN_PROPERTIES = "cataloguemanager-plugin.properties";
    ...
    /**
     * Loads the cataloguemanager plugin properties file from the given JAR file.
     *
     * The path to the properties file resource inside the JAR file is stored in the "cataloguemanager-Plugin-Properties-Path"
     * attribute of the JAR manifest. (Example: {@code org.cataloguemanager.plugins.cataloguemanager-plugin-map-widget})
     *
