...
public class V20190705071400_AddEventIndexSetsMigration extends Migration {
    ...
    public void upgrade() {
        ensureEventsStreamAndIndexSet(
                "cataloguemanager Events",
                "Stores cataloguemanager events.",
                ...
                "All events",
                "Stream containing all events created by cataloguemanager"
        );
        ensureEventsStreamAndIndexSet(
                "cataloguemanager System Events",
                "Stores cataloguemanager system events.",
                ...
                "All system events",
                "Stream containing all system events created by cataloguemanager"
        );
    }
