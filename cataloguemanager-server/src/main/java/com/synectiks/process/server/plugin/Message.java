...
import static com.synectiks.process.common.schema.GraylogSchemaFields.FIELD_ILLUMINATE_EVENT_CATEGORY;
import static com.synectiks.process.common.schema.GraylogSchemaFields.FIELD_ILLUMINATE_EVENT_SUBCATEGORY;
import static com.synectiks.process.common.schema.GraylogSchemaFields.FIELD_ILLUMINATE_EVENT_TYPE;
import static com.synectiks.process.common.schema.GraylogSchemaFields.FIELD_ILLUMINATE_EVENT_TYPE_CODE;
import static com.synectiks.process.common.schema.GraylogSchemaFields.FIELD_ILLUMINATE_TAGS;
import static com.synectiks.process.server.plugin.Tools.ES_DATE_FORMAT_FORMATTER;
import static com.synectiks.process.server.plugin.Tools.buildElasticSearchTimeFormat;
...
public class Message implements Messages, Indexable {
     ...
     * TODO: We might want to use the "xfcatlg_message_id" for this in the future to reduce storage and avoid having
    ...
    /**
     * cataloguemanager is writing internal metadata to messages using this field prefix. Users must not use this prefix for
     * custom message fields.
     */
    public static final String INTERNAL_FIELD_PREFIX = "xfcatlg_";

    /**
     * Will be set to the accounted message size in bytes.
     */
    public static final String FIELD_XFCATLG_ACCOUNTED_MESSAGE_SIZE = "xfcatlg_accounted_message_size";
     ...
     *
     */
    public static final String FIELD_XFCATLG_MESSAGE_ID = "xfcatlg_message_id";

    /**
     * Can be set when a message timestamp gets modified to preserve the original timestamp. (e.g. "clone_message" pipeline function)
     */
    public static final String FIELD_XFCATLG_ORIGINAL_TIMESTAMP = "xfcatlg_original_timestamp";

    /**
     * Can be set to indicate a message processing error. (e.g. set by the pipeline interpreter when an error occurs)
     */
    public static final String FIELD_XFCATLG_PROCESSING_ERROR = "xfcatlg_processing_error";

    /**
     * Will be set to the message processing time after all message processors have been run.
     */
    public static final String FIELD_XFCATLG_PROCESSING_TIMESTAMP = "xfcatlg_processing_timestamp";

    /**
     * Will be set to the message receive time at the input.
     */
    public static final String FIELD_XFCATLG_RECEIVE_TIMESTAMP = "xfcatlg_receive_timestamp";

    /**
     * Will be set to the hostname of the source node that sent a message. (if reverse lookup is enabled)
     */
    public static final String FIELD_XFCATLG_REMOTE_HOSTNAME = "xfcatlg_remote_hostname";

    /**
     * Will be set to the IP address of the source node that sent a message.
     */
    public static final String FIELD_XFCATLG_REMOTE_IP = "xfcatlg_remote_ip";

    /**
     * Will be set to the socket port of the source node that sent a message.
     */
    public static final String FIELD_XFCATLG_REMOTE_PORT = "xfcatlg_remote_port";

    /**
     * Can be set to the collector ID that sent a message. (e.g. used in the beats codec)
     */
    public static final String FIELD_XFCATLG_SOURCE_COLLECTOR = "xfcatlg_source_collector";

    /**
     * @deprecated This was used in the legacy collector/sidecar system and contained the database ID of the collector input.
     */
    @Deprecated
    public static final String FIELD_XFCATLG_SOURCE_COLLECTOR_INPUT = "xfcatlg_source_collector_input";

    /**
     * Will be set to the ID of the input that received the message.
     */
    public static final String FIELD_XFCATLG_SOURCE_INPUT = "xfcatlg_source_input";

    /**
     * Will be set to the ID of the node that received the message.
     */
    public static final String FIELD_XFCATLG_SOURCE_NODE = "xfcatlg_source_node";

    /**
     * @deprecated This was used with the now removed radio system and contained the ID of a radio node.
     */
    @Deprecated
    public static final String FIELD_XFCATLG_SOURCE_RADIO = "xfcatlg_source_radio";

    /**
     * @deprecated This was used with the now removed radio system and contained the input ID of a radio node.
     */
    @Deprecated
    public static final String FIELD_XFCATLG_SOURCE_RADIO_INPUT = "xfcatlg_source_radio_input";
    ...
    private static final ImmutableSet<String> GRAYLOG_FIELDS = ImmutableSet.of(
        FIELD_XFCATLG_ACCOUNTED_MESSAGE_SIZE,
        FIELD_XFCATLG_ORIGINAL_TIMESTAMP,
        FIELD_XFCATLG_PROCESSING_ERROR,
        FIELD_XFCATLG_PROCESSING_TIMESTAMP,
        FIELD_XFCATLG_RECEIVE_TIMESTAMP,
        FIELD_XFCATLG_REMOTE_HOSTNAME,
        FIELD_XFCATLG_REMOTE_IP,
        FIELD_XFCATLG_REMOTE_PORT,
        FIELD_XFCATLG_SOURCE_COLLECTOR,
        FIELD_XFCATLG_SOURCE_COLLECTOR_INPUT,
        FIELD_XFCATLG_SOURCE_INPUT,
        FIELD_XFCATLG_SOURCE_NODE,
        FIELD_XFCATLG_SOURCE_RADIO,
        FIELD_XFCATLG_SOURCE_RADIO_INPUT
    );
    ...
    public Map<String, Object> toElasticSearchObject(ObjectMapper objectMapper, @Nonnull final Meter invalidTimestampMeter) {
        ...
        obj.put(FIELD_XFCATLG_ACCOUNTED_MESSAGE_SIZE, getSize());
    ...
    public boolean getIsSourceInetAddress() {
        return fields.containsKey(FIELD_XFCATLG_REMOTE_IP);
    }

    public InetAddress getInetAddress() {
        if (!fields.containsKey(FIELD_XFCATLG_REMOTE_IP)) {
            return null;
        }
        final String ipAddr = (String) fields.get(FIELD_XFCATLG_REMOTE_IP);
        try {
