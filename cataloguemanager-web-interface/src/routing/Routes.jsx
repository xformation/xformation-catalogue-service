...
const defaultExport = AppConfig.xfcatlgAppPathPrefix() ? qualifyUrls(Routes, AppConfig.xfcatlgAppPathPrefix()) : Routes;
...
defaultExport.pluginRoute = (routeKey, throwError = true) => {
  ...
  const route = (AppConfig.xfcatlgAppPathPrefix() ? qualifyUrls(pluginRoutes, AppConfig.xfcatlgAppPathPrefix()) : pluginRoutes)[routeKey];
