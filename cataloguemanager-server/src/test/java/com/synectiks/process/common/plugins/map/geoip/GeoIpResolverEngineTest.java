...
import com.synectiks.process.common.plugins.map.ResourceExistsCondition;
...
public class GeoIpResolverEngineTest {
    ...
    public void filterResolvesIpGeoLocation() {
        ...
        messageFields.put("message", "Hello from 1.2.3.4");
        messageFields.put("extracted_ip", "1.2.3.4");
        messageFields.put(Message.FIELD_XFCATLG_REMOTE_IP, "1.2.3.4");
        messageFields.put("ipv6", "2001:4860:4860::8888");
        ...
        assertFieldNotResolved(message, "xfcatlg_remote_ip", "Should not have resolved text with an IP");
