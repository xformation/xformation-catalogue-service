...
public abstract class LookupDataAdapter extends AbstractIdleService {
    ...
    // This factory is implemented by LookupDataAdapter plugins that have been built before cataloguemanager 3.2.
    // We have to keep it around to make sure older plugins still load with cataloguemanager >=3.2.
    ...
    // This is the factory that should be implemented by LookupDataAdapter plugins which target cataloguemanager 3.2 and later.
