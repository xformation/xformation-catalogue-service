...
public class Cluster {
    ...
    /**
     * Requests the cluster health for all indices managed by cataloguemanager. (default: cataloguemanager_*)
     *
    ...
    public ElasticsearchStats elasticsearchStats() {
        ...
        final com.synectiks.process.server.system.stats.elasticsearch.ClusterStats clusterStats = clusterAdapter.clusterStats();
        ...
        final com.synectiks.process.server.system.stats.elasticsearch.ClusterHealth clusterHealth = com.synectiks.process.server.system.stats.elasticsearch.ClusterHealth.from(
                shardStats,
                pendingTasksStats
        );
