...
import com.synectiks.process.server.shared.bindings.GenericBindings;
import com.synectiks.process.server.shared.bindings.GenericInitializerBindings;
...
import com.synectiks.process.server.shared.bindings.SharedPeriodicalBindings;
import com.synectiks.process.server.shared.bindings.ValidatorModule;
import com.synectiks.process.server.shared.initializers.ServiceManagerListener;
import com.synectiks.process.server.shared.security.SecurityBindings;
...
import static com.synectiks.process.server.audit.AuditEventTypes.NODE_STARTUP_COMPLETE;
import static com.synectiks.process.server.audit.AuditEventTypes.NODE_STARTUP_INITIATE;
...
public abstract class ServerBootstrap extends CmdLineTool {
    ...
    @Option(name = {"-p", "--pidfile"}, description = "File containing the PID of cataloguemanager")
    private String pidFile = TMPDIR + FILE_SEPARATOR + "cataloguemanager.pid";
    ...
    protected void startCommand() {
        ...
        LOG.info("cataloguemanager {} {} starting up", commandName, version);
        ...
        try {
            ...
            LOG.error("cataloguemanager startup failed. Exiting. Exception was:", e);
            auditEventSender.failure(AuditActor.system(nodeId), NODE_STARTUP_INITIATE, auditEventContext);
            System.exit(-1);
        }
        ...
        LOG.info("cataloguemanager " + commandName + " up and running.");
