...
public class IndexSetValidator {
    ...
    public Optional<Violation> validate(IndexSetConfig newConfig) {
        ...
        // Example: new=cataloguemanager_foo existing=cataloguemanager => cataloguemanager is more generic so this is an error
        // Example: new=cataloguemanager        existing=cataloguemanager => gray    is more generic so this is an error
        // This avoids problems with wildcard matching like "cataloguemanager_*".
