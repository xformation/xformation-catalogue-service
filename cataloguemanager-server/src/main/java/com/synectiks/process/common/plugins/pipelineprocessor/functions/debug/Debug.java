...
public class Debug extends AbstractFunction<Void> {
    ...
    Debug() {
        valueParam = ParameterDescriptor.object("value").description("The value to print in the cataloguemanager-server log.").build();
    }
    ...
    public FunctionDescriptor<Void> descriptor() {
        return FunctionDescriptor.<Void>builder()
                ...
                .description("Print any passed value as string in the cataloguemanager-server log. Note that this will only appear in the " +
