...
public class HttpConfiguration {
    ...
    private static final int CATALOGUEMANAGER_DEFAULT_PORT = 9000;

    public static final String OVERRIDE_HEADER = "X-cataloguemanager-Server-URL";
    public static final String PATH_WEB = "";
    public static final String PATH_API = "api/";

    @Parameter(value = "http_bind_address", required = true)
    private HostAndPort httpBindAddress = HostAndPort.fromParts("127.0.0.1", CATALOGUEMANAGER_DEFAULT_PORT);
    ...
    public HostAndPort getHttpBindAddress() {
        return httpBindAddress
                ...
                .withDefaultPort(CATALOGUEMANAGER_DEFAULT_PORT);
    }
    ...
    public URI getHttpPublishUri() {
        if (httpPublishUri == null) {
            ...
            if (Tools.isWildcardInetAddress(inetAddress)) {
                ...
                return Tools.normalizeURI(httpPublishUri, httpPublishUri.getScheme(), CATALOGUEMANAGER_DEFAULT_PORT, httpPublishUri.getPath());
            }
        }
    }
    ...
    private URI getDefaultHttpUri(String path) {
        ...
        if (inetAddress != null && Tools.isWildcardInetAddress(inetAddress)) {
            ...
            try {
                ...
                LOG.error("Could not guess primary network address for \"http_publish_uri\". Please configure it in your cataloguemanager configuration.", e);
