...
public abstract class IndexFieldTypePollerIT extends ElasticsearchBaseTest {
    ...
    public void poll() {
        ...
        assertThat(dto.fields()).containsOnly(
                ...
                FieldTypeDTO.create("xfcatlg_receive_timestamp", "date"),
                FieldTypeDTO.create("xfcatlg_processing_timestamp", "date"),
                FieldTypeDTO.create("xfcatlg_accounted_message_size", "long"),
