 ...
 *
 * @see com.synectiks.process.server.plugin.BaseConfiguration#getHttpConnectTimeout()
 * @see com.synectiks.process.server.plugin.BaseConfiguration#getHttpReadTimeout()
 * @see com.synectiks.process.server.plugin.BaseConfiguration#getHttpWriteTimeout()
 * @see com.synectiks.process.server.plugin.BaseConfiguration#getHttpProxyUri()
 */
@Singleton
    ...
    public static class ProxyAuthenticator implements Authenticator {
        ...
        public Request authenticate(@Nonnull Route route, @Nonnull Response response) throws IOException {
            ...
            if (!authenticationMethods.contains(AUTH_BASIC)) {
                LOG.warn("cataloguemanager only supports the \"{}\" authentication scheme but the proxy server asks for one of the following: {}",
