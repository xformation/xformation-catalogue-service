...
public class EventTest {
    ...
    public void fromDto() {
        ...
        final EventDto eventDto = EventDto.builder()
                ...
                .originContext("urn:cataloguemanager:message:es:cataloguemanager_0:199a616d-4d48-4155-b4fc-339b1c3129b2")
                .eventTimestamp(now)
        ...
        assertThat(Event.fromDto(eventDto)).satisfies(event -> {
            ...
            assertThat(event.getOriginContext()).isEqualTo("urn:cataloguemanager:message:es:cataloguemanager_0:199a616d-4d48-4155-b4fc-339b1c3129b2");
