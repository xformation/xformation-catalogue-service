...
public interface IndexSet extends Comparable<IndexSet> {
     ...
     * <p>
     * Example: {@code ["cataloguemanager_0", "cataloguemanager_1", "cataloguemanager_2"]}
     *
     ...
     * <p>
     * Example: {@code "cataloguemanager_deflector"}
     *
     ...
     * <p>
     * Example: {@code "cataloguemanager_*"}
     *
     ...
     * <p>
     * Example: {@code "cataloguemanager_42"}
     *
     ...
     * <p>
     * Example: {@code {cataloguemanager_0=[], cataloguemanager_1=[], cataloguemanager_2=[cataloguemanager_deflector}}
     *
     ...
     * <p>
     * Example: {@code "cataloguemanager_42" => 42}
     *
