...
public abstract class Graylog2Module extends AbstractModule {
    ...
    protected void installCodec(MapBinder<String, Codec.Factory<? extends Codec>> mapBinder, Class<? extends Codec> codecClass) {
        if (codecClass.isAnnotationPresent(com.synectiks.process.server.plugin.inputs.annotations.Codec.class)) {
            final com.synectiks.process.server.plugin.inputs.annotations.Codec a = codecClass.getAnnotation(com.synectiks.process.server.plugin.inputs.annotations.Codec.class);
            ...
            LOG.error("Codec {} not annotated with {}. Cannot determine its id. This is a bug, please use that annotation, this codec will not be available",
                    codecClass, com.synectiks.process.server.plugin.inputs.annotations.Codec.class);
        }
    }
    ...
    // This should only be used by plugins that have been built before cataloguemanager 3.0.1.
